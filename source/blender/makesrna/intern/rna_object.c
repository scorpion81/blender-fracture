...
/*	RNA_def_property_collection_funcs(prop, NULL, NULL, NULL, NULL, NULL, NULL, NULL, "constraints__add", "constraints__remove"); */
	...
	prop = RNA_def_property(srna, "rigidbody_object", PROP_POINTER, PROP_NONE);
	RNA_def_property_pointer_sdna(prop, NULL, "rigidbody_object");
	RNA_def_property_struct_type(prop, "RigidBodyObject");
	RNA_def_property_ui_text(prop, "Rigid Body Object", "Settings and container for fractured rigid bodies");

	prop = RNA_def_property(srna, "rigidbody_constraint", PROP_POINTER, PROP_NONE);
	RNA_def_property_pointer_sdna(prop, NULL, "rigidbody_constraint");
	RNA_def_property_struct_type(prop, "RigidBodyConstraint");
	RNA_def_property_ui_text(prop, "Rigid Body Constraint", "Settings and container for rigidbody constraints");
