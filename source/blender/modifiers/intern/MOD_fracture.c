...
//unsure about mi->bb, its for volume fraction calculation....
...
static void search_centroid_based(FractureModifierData *rmd, Object* ob, MeshIsland* mi, MeshIsland** meshIslands, KDTree**combined_tree)
{
	int r = 0, limit = 0, i = 0;
